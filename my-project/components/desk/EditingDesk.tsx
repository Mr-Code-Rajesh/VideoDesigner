  ...
  return (
    <section id="desk" className="relative py-32 px-6 bg-black overflow-hidden">
      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="flex flex-col gap-4 p-2 bg-zinc-900/50 border border-white/5 rounded-3xl backdrop-blur-xl shadow-2xl">
          {/* Top Row: Browser + Preview + Scopes */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 h-auto lg:h-[500px]">
            {/* Project Browser */}
            <div className="lg:col-span-3 bg-zinc-950/50 rounded-2xl border border-white/5 p-4 hidden lg:flex flex-col">
          ...
          {/* Toolbar */}
          <div className="flex items-center justify-center gap-6 py-2 px-6 bg-zinc-950/50 rounded-xl border border-white/5">
            <MousePointer2 size={16} className="text-blue-500" />
            <Scissors size={16} className="text-white/20 hover:text-white transition-colors" />
            <Type size={16} className="text-white/20 hover:text-white transition-colors" />
            <Layers size={16} className="text-white/20 hover:text-white transition-colors" />
            <div className="h-4 w-[1px] bg-white/10" />
            <Music size={16} className="text-white/20 hover:text-white transition-colors" />
          </div>
